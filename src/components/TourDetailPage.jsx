...
const TourDetailPage = ({ selectedTour, setCurrentPage, toggleFavorite, favorites }) => {
  ...
  if (!selectedTour) return <div className="text-center py-12 text-blue-600" data-aos="fade-up">Tour not found</div>;
    ...
    <div className="min-h-screen bg-blue-50">
      ...
      <div className="relative h-96 md:h-[500px] overflow-hidden" data-aos="fade-in">
        ...
        <div className="absolute bottom-8 left-8 text-white" data-aos="fade-up" data-aos-delay="200">
          <span className="bg-blue-700 px-3 py-1 rounded-full text-sm font-semibold mb-2 inline-block">{selectedTour.category}</span>
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2" data-aos="fade-up" data-aos-delay="100">
            <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center">
                  <div className="flex items-center mr-6">
                    <Star className="h-5 w-5 text-blue-400 fill-current mr-1" />
                    <span className="text-lg font-semibold text-blue-600">{selectedTour.rating}</span>
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className={`p-3 rounded-full ${favorites.includes(selectedTour.id) ? 'bg-blue-600 text-white' : 'bg-blue-100 text-blue-600'} hover:bg-blue-700 hover:text-white transition-colors`}
                  >
              ...
              <h3 className="text-xl font-bold mb-4 text-blue-700">Tour Highlights</h3>
              ...
              <h3 className="text-xl font-bold mb-4 text-blue-700">What's Included</h3>
          ...
          <div className="lg:col-span-1" data-aos="fade-up" data-aos-delay="200">
            <div className="bg-white rounded-xl shadow-lg p-8 sticky top-8">
              <div className="text-center mb-6">
                <span className="text-4xl font-bold text-blue-700">Rs. {selectedTour.price}</span>
                <span className="text-gray-600 block">per person</span>
              </div>
              <button
                onClick={() => setCurrentPage('booking')}
                className="w-full bg-blue-600 text-white py-4 rounded-lg font-semibold text-lg hover:bg-blue-700 transition-all duration-300 transform hover:scale-105 shadow-lg mb-4"
              >
                Book Now
              </button>
              <div className="text-center text-sm text-blue-500 mb-6">
